...
import hoaDonResolve from './hoa-don-routing-resolve.service';

describe('HoaDon routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: HoaDonService;
  let resultHoaDon: IHoaDon | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IHoaDon returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        hoaDonResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultHoaDon = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultHoaDon).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IHoaDon>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
